...
class Arguments(object):
    ...
    def _add_global_args(self, glob):
        ...
        glob.add_argument('--pillage', help=argparse.SUPPRESS, action='store', dest='scan_time', nargs='?', const=10,
                          type=int)
        ...
        glob.add_argument('--nochill',
                          action='store',
                          type=int,
                          dest='no_chill_timer',
                          metavar="[num]",
                          default=None,
                          help=self._verbose('Seconds to wait until a client is Identified before moving on'))
        glob.add_argument('-nc', help=argparse.SUPPRESS, action='store', dest='no_chill_timer', type=int)
    ...
    def _add_wep_args(self, wep):
        ...
        wep.add_argument('--weprs',
                         ...
                         type=int,
                         help=self._verbose(
                             'Restart aireplay if no new IVs appear (default: {G}%d sec{W})' % self.config.wep_restart_stale_ivs))
        ...
        wep.add_argument('--weprc',
                         ...
                         type=int,
                         help=self._verbose(
                             'Restart aircrack after this delay (default: {G}%d sec{W})' % self.config.wep_restart_aircrack))
    ...
    def _add_wpa_args(self, wpa):
        ...
        wpa.add_argument('--wpadt',
                         ...
                         type=int,
                         help=self._verbose(
                             'Time to wait between sending Deauths (default: {G}%d sec{W})' % self.config.wpa_deauth_timeout))
        ...
        wpa.add_argument('--wpat',
                         ...
                         type=int,
                         help=self._verbose(
                             'Time to wait before failing WPA attack (default: {G}%d sec{W})' % self.config.wpa_attack_timeout))
        ...
        wpa.add_argument('--new-hs',
                         ...
                         help=Color.s(
                             'Captures new handshakes, ignores existing handshakes in ./hs (default: {G}off{W})'))
    ...
    def _add_wps_args(self, wps):
        ...
        wps.add_argument('--no-wps',
                         ...
                         dest='no_wps',
                         help=Color.s(
                             '{O}NEVER{W} use WPS attacks (Pixie-Dust) on non-WEP networks (default: {G}off{W})'))

        wps.add_argument('--wps-only',
                         action='store_true',
                         dest='wps_only',
                         help=Color.s(
                             '{G}ALWAYS{W} use WPS attacks (Pixie-Dust) on non-WEP networks (default: {G}off{W})'))
        # Alias
        ...
        wps.add_argument('--wps-time',
                         ...
                         type=int,
                         help=self._verbose(
                             'Total time to wait before failing PixieDust attack (default: {G}%d sec{W})' % self.config.wps_pixie_timeout))
        # Alias
        ...
        wps.add_argument('--wps-fails',
                         ...
                         type=int,
                         help=self._verbose(
                             'Maximum number of WPSFail/NoAssoc errors before failing (default: {G}%d{W})' % self.config.wps_fail_threshold))
        # Alias
        ...
        wps.add_argument('--wps-timeouts',
                         ...
                         type=int,
                         help=self._verbose(
                             'Maximum number of Timeouts before failing (default: {G}%d{W})' % self.config.wps_timeout_threshold))
        # Alias
    ...
    def _add_command_args(self, commands):
        ...
        commands.add_argument('-check', help=argparse.SUPPRESS, action='store', nargs='?', const='<all>',
                              dest='check_handshake')
