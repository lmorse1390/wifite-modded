...
class Configuration(object):
    ...
    def initialize(cls, load_interface=True):
        ...
        cls.tx_power = 30  # Wifi transmit power (0 is default)
        cls.interface = None
        ...
        cls.no_chill_timer = 45  # Wait time we are willing to spend on each AP without detecting any other Clients
    ...
    def load_from_arguments(cls):
        ...
        if args.wordlist:
            if os.path.exists(args.wordlist):
                ...
                cls.wordlist = None
                Color.pl(
                    '{+} {C}option:{O} wordlist {R}%s{O} was not found, wifite will NOT attempt to crack handshakes' % args.wordlist)
